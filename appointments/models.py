...
class CustomUser(models.Model):
    ...
    password = models.CharField(max_length=255)  # ADD THIS LINE
...
class Notification(models.Model):
    ...
    notification_type = models.CharField(max_length=20, choices=[('confirmation', 'Confirmation'), ('approval', 'Approval'), ('rejection', 'Rejection'),('reminder', 'Reminder')], default='confirmation')
